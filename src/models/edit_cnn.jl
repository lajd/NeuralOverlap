...
function _get_input_conv_layer(;k::Int64=3, c::Int64=8, activation=relu, use_batchnorm::Bool=false,
     use_input_batchnorm::Bool=false, pooling_method::String="max", pool_kernel::Int64=2)::Array
...
function _get_intermediate_conv_layers(l_in::Int64, n_layers::Int64; k::Int64=3, c::Int64=8,
    activation=relu, use_batchnorm::Bool=false, pooling_method::String="max",
    pool_kernel::Int64=2, conv_activation_fn_mod::Int64=1)::Array
    # -> CONV/FC -> BatchNorm -> ReLu(or other activation) -> Dropout -> CONV/FC ->
    layers = []
...
function _get_readout_layers(l_in::Int64, embedding_dim::Int64, n_layers::Int64;
    activation=relu, use_dropout::Bool=false, dropout_p::Float64=0.4, use_batchnorm::Bool=false)::Array
    # -> CONV/FC -> BatchNorm -> ReLu(or other activation) -> Dropout -> CONV/FC ->
    layers = []
